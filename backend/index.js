...
import { submitUserMessages, getLlmInstructions } from "./socket/gameHandler.js"
...
// //     // creating message history for LLM, might make this into a function
// //     const messages = [
...
//         await getLlmInstructions(roomCode, round);
//         // const room = await getRoom(roomCode);
...
//         if (!round) {
//             console.error(`No current round found for room ${roomCode}`);
//             return;
//         }
//         await submitUserMessages(roomCode, userId, userName, text, round);
//         // const round = currRounds[roomCode];
...
//         if (!roomCode || !usersInRoom[roomCode]) {
